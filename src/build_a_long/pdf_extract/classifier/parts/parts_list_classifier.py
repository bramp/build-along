...
class _PartsListScore(Score):
    ...
    Uses generic Candidate[Part] to enable automatic constraint mapping.
    SchemaConstraintGenerator matches Candidate[Part] to PartsList.parts.
    """

    part_candidates: list[Candidate[Part]] = []
    """List of Part candidates inside this parts list.

    The generic type Candidate[Part] tells SchemaConstraintGenerator that
...
class PartsListClassifier(LabelClassifier):
    ...
    - _PartsListScore.part_candidates: list[Candidate[Part]] maps to PartsList.parts
    """
